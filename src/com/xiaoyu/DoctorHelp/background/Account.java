...
import com.xiaoyu.DoctorHelp.background.config.CommonPreference;
...
public class Account {
    ...
    public static final String kDoctorName = "key_doctor_name";
    public static final String kDoctorTitle = "key_doctor_title";
    public static final String kGoodAt = "key_good_at";
    public static final String kBrief = "key_brief";
    public static final String kHospital = "key_hospital";
    ...
    public static Account loadAccount() {
        ...
        try {
            ...
            account.doctor_name = user.optString(kDoctorName);
            account.doctor_title = user.optString(kDoctorTitle);
            account.good_at = user.optString(kGoodAt);
            account.brief = user.optString(kBrief);
            account.hospital = user.optString(kHospital);
    ...
    public void saveMeInfoToPreference() {
        ...
        try {
            ...
            info.put(kDoctorName, doctor_name);
            info.put(kDoctorTitle, doctor_title);
            info.put(kGoodAt, good_at);
            info.put(kBrief, brief);
            info.put(kHospital, hospital);
